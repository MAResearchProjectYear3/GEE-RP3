...
# File paths
file_paths = [
    "Merged_Bangladesh_Event2a_1.csv",
    "Merged_Bangladesh_Event2a_2.csv",
    "Merged_Bangladesh_Event2a_3.csv"
]
...
corrected_file_path = "Merged_Bangladesh_Event2a_Combined.csv"
