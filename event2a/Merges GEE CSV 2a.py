...
# Load CSV files
vv_vh_df = pd.read_csv('Bangladesh_VVVH2a_Ending_3.csv')
elevation_df = pd.read_csv('Bangladesh_Event2a_Elevation_3.csv')
flooded_df = pd.read_csv('Bangladesh_Event2a_Flooded_3.csv')
landcover_df = pd.read_csv('Bangladesh_Event2a_Landcover_3.csv')  # Corrected file name
slope_df = pd.read_csv('Bangladesh_Event2a_Slope_3.csv')
...
output_path = "Merged_Bangladesh_Event2a_3.csv"
