...
# File paths
file_paths = [
    "Merged_Bangladesh_Event1a_1.csv",
    "Merged_Bangladesh_Event1a_2.csv",
    "Merged_Bangladesh_Event1a_3.csv"
]
...
corrected_file_path = "Merged_Bangladesh_Event1a_Combined.csv"
