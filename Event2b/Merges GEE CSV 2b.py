...
# Load CSV files
vv_vh_df = pd.read_csv('Bangladesh_VVVH2b_Before_1.csv')
elevation_df = pd.read_csv('Bangladesh_Event2b_Elevation_1.csv')
flooded_df = pd.read_csv('Bangladesh_Event2b_Flooded_1.csv')
landcover_df = pd.read_csv('Bangladesh_Event2b_Landcover_1.csv')  # Corrected file name
slope_df = pd.read_csv('Bangladesh_Event2b_Slope_1.csv')
...
output_path = "Merged_Bangladesh_Event2b_1.csv"
