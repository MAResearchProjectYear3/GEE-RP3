...
def generate_random_points(num_points, min_lat, max_lat, min_lon, max_lon, csv_filename=None):
    ...
    np.random.seed(93)  # For reproducibility
    random_points = [
...
min_lon, min_lat = 89.18725872184673,22.35796119797154
max_lon, max_lat = 89.38071129118404,22.53790395745951

# Number of random points to generate
num_points = 100000

# User-defined filename (set to None to use default)
csv_filename = "GEE_Event_02b_Bangladesh_3.csv"
