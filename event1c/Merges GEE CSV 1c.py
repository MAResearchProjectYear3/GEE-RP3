...
# Load CSV files
vv_vh_df = pd.read_csv('Bangladesh_VVVHc_Before_1.csv')
elevation_df = pd.read_csv('Bangladesh_Event1c_Elevation_1.csv')
flooded_df = pd.read_csv('Bangladesh_Event1c_Flooded_1.csv')
landcover_df = pd.read_csv('Bangladesh_Event1c_Landcover_1.csv')  # Corrected file name
slope_df = pd.read_csv('Bangladesh_Event1c_Slope_1.csv')
...
output_path = "Merged_Bangladesh_Event1c_1.csv"
