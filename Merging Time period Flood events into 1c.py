...
# File paths
file_paths = [
    "Merged_Bangladesh_Event1c_1.csv",
    "Merged_Bangladesh_Event1c_2.csv",
    "Merged_Bangladesh_Event1c_3.csv"
]
...
corrected_file_path = "Merged_Bangladesh_Event1c_Combined.csv"
