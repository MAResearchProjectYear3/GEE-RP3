...
# File paths
file_paths = [
    "Merged_Bangladesh_Event1b_1.csv",
    "Merged_Bangladesh_Event1b_2.csv",
    "Merged_Bangladesh_Event1b_3.csv"
]
...
corrected_file_path = "Merged_Bangladesh_Event1b_Combined.csv"
